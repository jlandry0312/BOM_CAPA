...
N = Range("SMDataModel[#Status]").Rows.Count
...
For i = 1 To N
    ...
    If (Sheets("Data").Cells(i, 2).Value = "A" And Sheets("Data").Cells(i, 1).Value = "P") Then
    ...
    If (Sheets("Data").Cells(i, 2).Value = "O" And Sheets("Data").Cells(i, 1).Value = "R") Then
        With Sheets("Master").Range(formatRange)
       'Red
